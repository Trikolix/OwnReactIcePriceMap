...
const CookieBanner = () => {
  ...
  return (
    <BannerWrapper>
      <TextContainer>
        <p>
          Wir nutzen Cookies und ähnliche Technologien (wie den Local Storage), um essentielle Funktionen wie den Login, deine Einstellungen und die Kartenanzeige zu ermöglichen.
        </p>
        <p>
