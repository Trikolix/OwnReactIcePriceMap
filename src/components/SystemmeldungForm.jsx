...
export default function SystemmeldungForm() {
    ...
    const loadHistory = async () => {
        setLoading(true);
        try {
            const res = await fetch(`${import.meta.env.VITE_API_BASE_URL}/systemmeldung.php?action=list`);
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            const url = editing
                ? `${import.meta.env.VITE_API_BASE_URL}/systemmeldung.php?action=update`
    ...
    const deleteMeldung = async (id) => {
        ...
        await fetch(`${import.meta.env.VITE_API_BASE_URL}/systemmeldung.php?action=delete&id=${id}`);
        loadHistory();
    };
