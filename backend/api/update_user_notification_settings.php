...
if ($row) {
    // Update
    $sql = "UPDATE user_notification_settings SET notify_checkin_mention = :mention, notify_comment = :comment, notify_comment_participated = :comment_participated, notify_news = :news, notify_team_challenge = :team_challenge, notify_checkin_mention_push = :mention_push, notify_comment_push = :comment_push, notify_comment_participated_push = :comment_participated_push, notify_news_push = :news_push, notify_team_challenge_push = :team_challenge_push, notify_photo_challenge = :photo_challenge, notify_photo_challenge_push = :photo_challenge_push, notify_like = :notify_like, notify_like_push = :notify_like_push, push_enabled_web = :push_enabled_web, push_enabled_android = :push_enabled_android, updated_at = NOW() WHERE user_id = :user_id";
    $stmt = $pdo->prepare($sql);
