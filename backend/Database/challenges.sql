...
CREATE TABLE `challenges` (
  ...
  `difficulty` enum('leicht','mittel','schwer','individuell') COLLATE utf8mb4_general_ci NOT NULL,
  `created_at` datetime DEFAULT CURRENT_TIMESTAMP,
  `valid_from` datetime DEFAULT CURRENT_TIMESTAMP,
  `custom_min_distance_m` int DEFAULT NULL,
  `custom_max_distance_m` int DEFAULT NULL,
