...
DROP VIEW kugel_scores;
CREATE SQL SECURITY INVOKER VIEW kugel_scores AS
...
DROP VIEW softeis_scores;
CREATE SQL SECURITY INVOKER VIEW softeis_scores AS WITH bewertete_checkins AS(
    SELECT
        nutzer_id,
        eisdiele_id,
        geschmackbewertung,
