...
class IceAutumnEvaluator extends BaseAwardEvaluator {
    const AWARD_ID = 46;
    ...
    public function evaluate(int $userId): array {
        ...
        if ($levelData) {
            $count = $this->getCheckinForAutumnCount($userId, $cur_year);
    ...
    private function getCheckinForAutumnCount(int $userId, int $year): int {
        global $pdo;
