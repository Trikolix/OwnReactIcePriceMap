...
if (isset($currentUserId)) {
    ...
    if (!$awardId) {
        $response['message'] = 'Ungültige Anfrage: award_id fehlt.';
        file_put_contents($log_path, "Invalid request: missing award_id.\n", FILE_APPEND);
    ...
    try {
        ...
        $achievements = $evaluator->evaluate($currentUserId, $awardId);
